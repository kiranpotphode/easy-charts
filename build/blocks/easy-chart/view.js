...
"use strict";
/*!***************************************!*\
  !*** ./src/blocks/easy-chart/view.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_chart_js_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../js/chart-js-adapter */ "./src/js/chart-js-adapter.js");
/* harmony import */ var _scss_easy_charts_public_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../scss/easy-charts-public.scss */ "./src/scss/easy-charts-public.scss");
...
document.querySelectorAll('.ec-chartjs-chart-container').forEach(canvas => {
  ...
  fetch(`/wp-json/wp/v2/easy_charts/${idNumber}/chart-data`).then(res => res.json()).then(data => {
    try {

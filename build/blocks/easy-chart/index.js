...
/***/ "./src/blocks/easy-chart/block.json":
/*!******************************************!*\
  !*** ./src/blocks/easy-chart/block.json ***!
  \******************************************/
/***/ ((module) => {
...
function parseChartJSData(rawData, rawConfig, extraConfig) {
  ...
  const scaleTicksStyles = {
    ...
    // Limits the number of x-axis ticks.
  ...
  const options = {
    ...
    scales: {
      y: {
        ...
        // For stepped up bar chart.

        title: {
          display: !!rawConfig.meta.vlabel.length,
          text: [rawConfig.meta.vlabel, rawConfig.meta.vsublabel],
          // Vertical caption.
          font: {
            size: rawConfig.axis.fontsize,
            family: rawConfig.axis.fontfamily,
      ...
      x: {
        ...
        title: {
          ...
          text: [rawConfig.meta.hlabel, rawConfig.meta.hsublabel],
          // Horizontal caption.
          font: {
            size: rawConfig.axis.fontsize,
            family: rawConfig.axis.fontfamily,
...
function chartJs(chartSelector, ec_chart_data) {
  ...
  chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.set('plugins.datalabels', {
    anchor: 'center'
  });
...
function getChartLabels(rawData) {
  // Extract all unique labels dynamically.
  return Array.from(new Set(Object.values(rawData).flat().map(entry => entry.name))).sort(); // Sorting for consistency.
}
function getDataSets(rawData, labels, colorPalette, extraConfig) {
  ...
  return legends.map((legend, index) => {
    ...
    let data = labels.map(xAxis => rawData[legend].find(entry => entry.name === xAxis)?.value || 0);
    let cumulative = 0;
...
const downloadChartImagePlugin = {
  ...
  afterDraw(chart, _args, options) {
    ...
    canvas.onclick = e => {
      ...
      if (clickX >= x && clickX <= x + textWidth && clickY >= y - fontSize && clickY <= y) {
...
class PowScale extends chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Scale {
  ...
  buildTicks() {
    var _ticks$0$value, _ticks$value;
    const ticks = [];
    ...
    this.min = (_ticks$0$value = ticks[0]?.value) !== null && _ticks$0$value !== void 0 ? _ticks$0$value : this.min;
    this.max = (_ticks$value = ticks[ticks.length - 1]?.value) !== null && _ticks$value !== void 0 ? _ticks$value : this.max;
    return ticks;
  }
  configure() {
    super.configure();
...
class SymlogScale extends chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Scale {
  ...
  generateTickLabels(ticks) {
    const minimalDecimalPlaces = Math.max(0, Math.ceil(-Math.log10(Math.min(...ticks.map(t => Math.abs(t.value - (ticks[0]?.value || 0)))) || 0)));
    ticks.forEach(tick => {
...
"use strict";
/*!****************************************!*\
  !*** ./src/blocks/easy-chart/index.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./block.json */ "./src/blocks/easy-chart/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit */ "./src/blocks/easy-chart/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./save */ "./src/blocks/easy-chart/save.js");
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_3__.registerBlockType)('easy-charts/easy-chart', {
